...
const ProductDetails = () => {
    ...
    // set items to local storage .. for Add to card function //
        ...
        <div>
            ...
            <div className="container px-5 py-24 mx-auto">
                ...
                <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <ReportProduct singleProductData={singleProductData}></ReportProduct>
                    </div>
                </div>
                </div>
