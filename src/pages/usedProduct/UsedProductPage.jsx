    ...
    return (
       ...
       <>
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
            ...
            Welcome to Epic Deals! We are an innovative and customer-centric e-commerce platform that aims to revolutionize your online shopping experience. E-commerce has experienced tremendous growth worldwide.
            </p>
            </header>
            ...
            <div className="mt-4 lg:mt-8 lg:grid lg:grid-cols-4 lg:items-start lg:gap-8">
                {/* side nav , or side option form for shorting the product by different different key */}
            ...
            {/* product card start form hare  */}
            
            <div className="lg:col-span-3">
                <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">

                    {
                        usedProductData?.length ===0 &&
                             <>
                             <div></div>
